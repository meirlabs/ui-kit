import { Toaster, toast, type ToastPlacement } from "../../src/components/Toast";
  ...
  return (
    <div className="demo-row" style={{ flexWrap: "wrap" }}>
      ...
      <button
        className="ml-btn ml-btn-secondary"
        onClick={() =>
          toast("Won't auto-dismiss", { description: "Duration 0.", duration: 0 })
        }
      >
        Persistent
      </button>
  ...
  return (
    <>
      ...
      <div className="demo-section">
        ...
        <Triggers />
        <Toaster placement={placement} visibleToasts={3} />
      </div>
    </>
  );
}
